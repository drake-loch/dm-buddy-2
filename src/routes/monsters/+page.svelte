<script lang="ts">
	...
	import { getMonsters, type Monster } from '../../utilities/helpers/monsterHelper/monsterHelper';

	const monsters: Monster[] = getMonsters();
</script>

<PageLayout>
	<div class="w-full p-2 md:p-0 md:flex md:flex-col md:items-center overflow-hidden">
		<h1 class="text-3xl mb-12">Monsters</h1>
		<div class="w-full md:w-1/2 flex justify-center">
			...
			>
				...
				<div class="w-full min-h-[10rem] flex justify-center items-center" slot="emptyState">
					<p>No monsters found. Create a new Monster to get started.</p>
				</div>
			</Table>
		</div>
	</div>
