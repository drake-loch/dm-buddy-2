<script lang="ts">
	import type { Ability } from '../../../../../utilities/helpers/charHelper';
	...
	export let disableSkillsUI = false;
...
{#if !disableSkillsUI}
	<button type="button" class="w-full border mt-4" on:click={() => (showSkills = !showSkills)}
